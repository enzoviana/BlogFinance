    ...
    <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
      ...
      <div className="grid grid-cols-1 gap-4 mb-4">
        <div>
          ...
          <label className="text-gray-500 cursor-pointer" htmlFor="storeData"> Sauvegarder mon Email et mon Nom pour la prochaine fois</label>
        </div>
      </div>
      ...
      <div className="mt-8">
        ...
        {showSuccessMessage && <span className="text-xl float-right font-semibold mt-3 text-green-500">Commentaire en attente de validation</span>}
      </div>
    </div>
  );
};
